...
if ( $query->have_posts() ) {
	...
	$content .= '<div class="row  latest-nbolck npub-Sidebar-Medium npub-big-title">';
	...
	while ( $query->have_posts() ) {	
		...
		$content  .= '<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 mb-3 check-in-view">';

		$content  .= '<div class="four-col-img pb-3 check-in-view"><a href="' . esc_url( get_permalink() ) . '"><span class="size-npub-small">' . get_the_post_thumbnail( $post->ID ) . '</span></a></div>';
